...
mixin _$ProjectorNode {
 ...
 String get id; String get name; String get ipAddress; int get port; String get login; String get password; double get x; double get y; PowerStatus get powerStatus; ShutterStatus get shutterStatus; ConnectionStatus get connectionStatus; String get serialNumber; String get runtime; String get lightRuntime; String get intakeTemp; String get exhaustTemp; String get acVoltage; String get errors; String get input; String get signal; String? get groupId;
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,ipAddress,port,login,password,x,y,powerStatus,shutterStatus,connectionStatus,serialNumber,runtime,lightRuntime,intakeTemp,exhaustTemp,acVoltage,errors,input,signal,groupId]);
...
class _ProjectorNode implements ProjectorNode {
  const _ProjectorNode({required this.id, required this.name, required this.ipAddress, this.port = 1024, this.login = 'admin1', this.password = 'panasonic', required this.x, required this.y, this.powerStatus = PowerStatus.standby, this.shutterStatus = ShutterStatus.closed, this.connectionStatus = ConnectionStatus.offline, this.serialNumber = '-', this.runtime = '-', this.lightRuntime = '-', this.intakeTemp = '-', this.exhaustTemp = '-', this.acVoltage = '-', this.errors = '-', this.input = '-', this.signal = '-', this.groupId});
